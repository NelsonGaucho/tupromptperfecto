...
publicación. El tono debe ser [formal/casual/inspirador] y dirigido a [demografía].`;
  ...
  return (
    <div className="mt-10 max-w-3xl mx-auto text-muted-foreground">
      <h2 className="text-2xl font-semibold text-foreground mb-6">Guía Completa: Cómo Usar Prompts Efectivos con ChatGPT</h2>
      
      <CollapsibleContent title="¿Por qué son importantes los prompts bien formulados?">
        <p>
      ...
      <CollapsibleContent title="Anatomía de un prompt efectivo">
      ...
      <CollapsibleContent title="Técnicas avanzadas para mejorar tus prompts">
      ...
      <CollapsibleContent title="Ejemplos prácticos de prompts para diferentes propósitos">
      ...
      <CollapsibleContent title="Optimización de prompts para SEO">
        <p>
      ...
      <CollapsibleContent title="Errores comunes a evitar en tus prompts">
        <ul className="list-disc pl-5 space-y-2">
      ...
      <CollapsibleContent title="Cómo evaluar y mejorar tus prompts">
        <p>
